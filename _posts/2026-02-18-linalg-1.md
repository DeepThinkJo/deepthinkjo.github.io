...
tags: [math, linear-algebra, ai, ml, engineering, vector, span, basis, dimension]
math: true
---
...
However, it is well worth knowing several vector spaces.
...
### Basis and Dimension in $\mathbb{F}^n$
...
### Basis and Dimension in $\mathbb{F}^{m \times n}$
...
### Basis and Dimension in $\mathbb{P}_n$
...
The significance of this thought process does not lie in its novelty.  
In fact, mathematicians have long categorized and explored complex function spaces to identify their bases;  
thus, my realization is by no means the first of its kind.  
Nevertheless, I took the initiative to contemplate concepts that were not explicitly covered in my linear algebra textbook.

Moving beyond the mere definition of a basis for function spaces, I integrated this with the concept of Taylor series from Calculus.  
Such an insight would have been impossible had I not pondered the basis of function spaces beyond the textbook, lacked intuition regarding the linearity of functions, or failed to see the Taylor series as a versatile tool rather than just a daunting chapter in a syllabus.  
This experience taught me that only when you study a subject deeply enough to connect it with other fields can you truly identify and solve new problems.
